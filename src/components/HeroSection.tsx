  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={heroBg} alt="Trivanta office" className="w-full h-full object-cover" width={1920} height={1080} />
      ...
      <div className="container mx-auto px-4 relative z-10 pt-20">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <span className="inline-block bg-primary text-primary-foreground font-heading font-bold text-sm tracking-widest px-4 py-1.5 rounded-sm mb-6 uppercase">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/about"
                className="bg-primary text-primary-foreground font-heading font-bold px-8 py-3.5 rounded-md hover:opacity-90 transition-opacity flex items-center gap-2 text-lg"
              >
                Explore Our Services <ArrowRight size={20} />
              </Link>
              <Link
                to="/contact"
                className="border-2 border-primary-foreground text-primary-foreground font-heading font-bold px-8 py-3.5 rounded-md hover:bg-primary-foreground hover:text-foreground transition-colors text-lg"
              >
                Contact Us
              </Link>
            </div>
