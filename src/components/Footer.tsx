...
const SocialIcon = ({ d, label }: { d: string; label: string }) => (
  <a href="#" className="w-10 h-10 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-primary transition-colors" aria-label={label}>
        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              ...
              <SocialIcon label="LinkedIn" d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2zM4 6a2 2 0 100-4 2 2 0 000 4z" />
